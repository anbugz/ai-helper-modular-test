...
# ============================================================
# ОБРАБОТКА ГОЛОСОВЫХ СООБЩЕНИЙ (Whisper small)
# ============================================================
@dp.message(F.voice)
async def handle_voice(message: Message):
    ...
    # message.copy_to/send_copy не подходит — нужен Message для handle_text
    ...
    from utils import _last_request_time
    _last_request_time.pop(user_id, None)

    # Передаём в основной обработчик
